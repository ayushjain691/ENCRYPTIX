...
stone_image1 = Image.open("stone.png")
stone_image = ImageTk.PhotoImage(stone_image1)

paper_image1 = Image.open("paper.png")
paper_image = ImageTk.PhotoImage(paper_image1)

scissors_image1 = Image.open("sessiors.png")
scissors_image = ImageTk.PhotoImage(scissors_image1)

msg=Label(
  win, text='Make Your Choice',
  font=("Courier",25),relief=GROOVE)
msg.place(relx=0.5,rely=0.09,anchor =CENTER)

user_input_stone = Button(
  win, width=200, height=200, image=stone_image,
  command=user_choice_stone, relief=GROOVE)
user_input_stone.place(relx=0.2, rely=0.35, anchor=CENTER)

user_input_paper = Button(
  win, width=200, height=200, image=paper_image,
  command=user_choice_paper, relief=GROOVE)
user_input_paper.place(relx=0.5, rely=0.35, anchor=CENTER)

user_input_scissors = Button(
  win, width=200, height=200, command=user_choice_scissors,
  image=scissors_image, relief=GROOVE)
user_input_scissors.place(relx=0.8, rely=0.35, anchor=CENTER)

ent1 = Entry(
  win, textvariable=result, width=27,
  font=('Ubuntu', 24), relief = GROOVE)
ent1.place(relx=0.5, rely=0.65, anchor=CENTER) 

ent2 = Entry(
  win, textvariable=score_you, width=2,
  font=('Ubuntu', 24), relief = GROOVE)
ent2.place(relx=0.3, rely=0.85, anchor=CENTER) 

msg2 = Label(
  win, text=' You ', font=("Courier", 12), relief=GROOVE)
msg2.place(relx=0.3, rely=0.79, anchor=CENTER)

msg3 = Label(
  win, text=' Com ', font=("Courier", 12), relief=GROOVE)
msg3.place(relx=0.7, rely=0.79, anchor=CENTER)

msg4 = Label(
  win, text=' Score Board ', font=("Courier", 18), relief=FLAT)
msg4.place(relx=0.5, rely=0.85, anchor=CENTER)

ent3 = Entry(
  win, textvariable=score_com, width=2,
  font=('Ubuntu', 24), relief=GROOVE)
ent3.place(relx=0.7, rely=0.85, anchor=CENTER)

stop = tk.Button(
  win, text='STOP', width=91, command=win.destroy,
  bg="green", activebackground="red", relief=GROOVE)
